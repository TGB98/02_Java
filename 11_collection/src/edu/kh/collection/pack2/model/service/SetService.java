...
//		Set<String> set = new TreeSet<String>();
		...
		// 2. 반환형 : int size() : Set에 저장된 객체의 수 반환
		System.out.println( "set.size() : " + set.size() );
		
		// 3. 반환형 : boolean remove(E e) :
		...
		// 4. 반환형 : boolean contains(E e) : 
		// 전달 받은 매개변수 e가 Set에 있으면 true, 없으면 false
		System.out.println( "쿠팡 있는지 검사 : " + set.contains("쿠팡") );
		System.out.println( "삼성 있는지 검사 : " + set.contains("삼성") );
		
		// 5. 반환형 : void clear() : Set에 저장된 내용을 모두 삭제
		set.clear();
		
		// 6. 반환형 : boolean isEmpty() : 비어있으면 true, 아니면 false
		System.out.println( set.isEmpty() );
		System.out.println( set );
		
		// hash 함수 -> 해시 테이블
		// Java 버전, JVM 환경, OS 환경이 일치한다면 해시 테이블이 동일할 수 있다.
	...
	public void method2() {
		...
		while(it.hasNext()) {
			...
			// 반환형 : E Iterator.next() : 다음 요소를 꺼내와 반환.
			String temp = it.next();
	...
	public void method3() {
		...
		Person p1 = new Person("고길동", 33, '남');
		Person p2 = new Person("고길동", 33, '남');
		Person p3 = new Person("고길동", 30, '남');
		Person p4 = new Person("마이콜", 28, '남');
		...
		// - 같은 필드값을 가진 객체는 번호가 같다. ( p1과 p2 )
		System.out.println("p1 : " + p1.hashCode()); // 45422105
		System.out.println("p2 : " + p2.hashCode()); // 45422105
