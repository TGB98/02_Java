...
// 배열의 인덱스 범위 벗어남 : 길이가 4칸짜리 배열인데, 없는 인덱스 번호인 4에 접근 하려 해서 발생한 에러.
	...
	public void ex5() {
		...
		// Arrays.toString(배열명) : 모든 요소 값을 출력해줌.
		System.out.println ( Arrays.toString(arr) );
	...
	public void ex6() {
		// 점심 메뉴 뽑기 프로그램
		String arr[] = {"김밥", "서브웨이", "햄버거", "국밥", "백반", "짜장면"};
	...
	public void ex8() {
		...
		for(int i = 0; i < arr.length; i++) {
			...
			if(arr[i].equals(str)) { // String 비교시 equals() 사용
...
// 4 ) count (숫자세기)
		...
		// 1. 문자열 입력 받아 한 글자씩 잘라내어 char 배열에 순서대로 저장
