...
public class ExceptionService {
	...
	public void ex2() {
		...
		try {
			...
			int input1 = sc.nextInt(); // int형이 아닌 다른 형을 넣었을 때
...
// java.lang.NullPointerException: Cannot invoke "String.charAt(int)" because "str" is null	
		...
		//            ㄴ InputMismatchException, ArithmeticException
			...
			// 다형성 업 캐스팅에 의해 모두 잡아서 처리 가능
			
			System.out.println("일단 예외가 발생해서 처리함.");
			e.printStackTrace();
	...
	public void ex3() {
		...
		try {
			...
			sc.close(); // 스캐너 통로 닫기 : 메모리 누수 방지 코드
