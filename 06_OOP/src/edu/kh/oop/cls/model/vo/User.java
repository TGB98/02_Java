...
public class User {
	...
	// 자바는 기본적으로 필드명, 생성자명, 메서드명, 변수명 등의
	// 중복을 허용하지 않음.
	// Duplicate ~~ : 중복되면 나타나는 에러 메시지
	...
	// public User() {} // 기본 생성자가 이미 작성되어있어서 에러가 뜸.
	...
	public User(String userId, int userAge) {} // 매개변수의 개수와 동일한 것은 있지만, 하나의 타입이 다름.
	// -> 오버로딩 성립
