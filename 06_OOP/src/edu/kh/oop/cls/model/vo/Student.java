...
//[접근제한자][예약어] class 클래스명 { }
	...
	// getter 만 만들어진 이유 : final 예약어가 붙은 TEMP1은 상수이기 때문에
	// 재대입이 불가함. ( == setter 필요가 없음 )
	public int getTEMP1() {
		return TEMP1;
	}
	...
	public void ex1() {
		...
		TestVO test = new TestVO(); // 같은 패키지 안에서만 접근 가능.
		
		// 필드 접근제한자 확인하기
		// v1~v4 까지 전부 Student 클래스 내부에서 생성된 변수이기 때문에
		// 같은 클래스 내부인 이 곳에서 직접 접근 가능하다.
